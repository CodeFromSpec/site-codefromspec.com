---
code-from-spec: ROOT/content/sections/rationale@h9V7UXHJBv8i9iAmfCwiWFirF4Y
title: Rationale
...
AI changes the economics. When code is generated from spec, the spec does not drift because the code is derived from it. The most expensive aspect of formal specifications — keeping them current — disappears. For the first time, rigor and speed point in the same direction. It is cheaper to specify precisely and generate than to code ad-hoc and fix.
