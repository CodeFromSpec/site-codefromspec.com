...
- [Telling the agent what changed](/articles/telling-the-agent-what-changed) — July 1, 2026 — The fix for anchoring: a cache, a hash comparison, and a one-word disposition per spec position. What worked, and the elegant hypothesis that didn't.
