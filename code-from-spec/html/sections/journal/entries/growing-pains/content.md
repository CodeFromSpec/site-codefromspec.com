...
The rationale was pure argument: here is why this should work.
The essay is an instrument: here is how to analyze whether it
does, and under what conditions.
...
engages with. It is not ready yet, but it is close.
...
tree structure, what resists the drift toward prompt — but
digesting those lessons into concrete plans is work that has not
been done yet. The instrument exists. Using it on the project's
